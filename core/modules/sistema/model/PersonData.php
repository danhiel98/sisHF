...
class PersonData {
	...
	public function add_client(){
		$sql = "insert into cliente (dui, nombre, apellido, genero, fechaNacimiento, telefono, nit, email, nrc) ";
		$sql .= "values (\"$this->dui\",\"$this->name\",\"$this->lastname\",\"$this->genero\",\"$this->birth\",\"$this->phone\",\"$this->nit\",\"$this->email\",\"$this->nrc\")";
		Executor::doit($sql);
	}
