      ...
      <form action="" class="form-horizontal" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-group control-group">
            ...
            <div class="col-sm-8 controls">
              <input type="text" name="enumeroCuenta" class="form-control" id="enumeroCuenta" placeholder="N&uacute;mero de cuenta bancaria" maxlength="25" data-validation-regex-regex="[0-9A-Za-z-]{10,25}" data-validation-regex-message="Número de cuenta no válido" readonly="readonly">
            </div>
          </div>
          <div class="form-group control-group">
          ...
          <div class="form-group control-group">
            ...
            <div class="col-sm-8 controls">
              <input type="text" name="ecomprobante" class="form-control" id="ecomprobante" placeholder="N&uacute;mero de comprobante" data-validation-regex-regex="[0-9A-Za-z-]*" data-validation-regex-message="Introduzca un n&uacute;mero v&aacute;lido" maxlength="15" minlength="5" required>
            </div>
          </div>
        </div>
