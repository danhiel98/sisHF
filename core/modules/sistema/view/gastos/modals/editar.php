      ...
      <form action="" class="form-horizontal" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-group control-group">
            ...
            <div class="col-sm-8 controls">
              <input type="text" name="ecomprobante" class="form-control" id="ecomprobante" placeholder="N&uacute;mero de comprobante" data-validation-regex-regex="[0-9]*" data-validation-regex-message="Introduzca un n&uacute;mero v&aacute;lido" maxlength="32" minlength="4">
            </div>
          </div>
        </div>
