          ...
          <div class="form-group control-group">
            ...
            <div class="col-sm-8 controls">
              <div class="input-group">
                <textarea class="form-control" name="descripcion" rows="3" cols="80" id="descripcion" required placeholder="Introduzca la descripci&oacute;n del servicio" data-validation-regex-regex="[Á-Úá-ú#().,_/\w\s]{3,200}" data-validation-regex-message="Introduzca una dirección válida" maxlength="150"></textarea>
              </div>
            </div>
          </div>
          <div class="form-group control-group">
