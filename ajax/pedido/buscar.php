            ...
            <table class="table table-bordered table-hover">
                ...
                foreach($productos as $prod){
                    ...
                    <tr>
                        ...
                        <td>
                            <form class="form-inline enviar" data-type="product" method="POST" action="ajax/pedido/<?php if($found){echo "quitar";}else{ echo "addxsell";} ?>.php">
                                ...
                                <div class="form-group control-group">
                                    <div class="controls">
                                        <div class="input-group">
                                            <input type="text" class="form-control input-sm" name="cantidad" value="<?php if($found){echo $cantidad;}else{ echo "1";} ?>" style="max-width:65px;" min="1" placeholder="Cantidad" pattern="[\d]{1,8}" onkeypress="return soloNumeros(event)" maxlength="8" required <?php if($found){echo "disabled=disabled";} ?>>
        ...
        <table class="table table-bordered table-hover">
            ...
            <?php foreach ($servicios as $srv): $found = false; $cantidad = 0; ?>
                <tr>
                    ...
                    <td>
                        <?php if(isset($_SESSION["cartp"])){ foreach ($_SESSION["cartp"] as $c) { if($c["service_id"] == $srv->id){ $cantidad = $c["cantidad"]; $found=true; break; }}} ?>
                        <form class="form-inline enviar" data-type="service" method="post" action="ajax/pedido/<?php if($found){echo "quitar";}else{ echo "addxsell";} ?>.php">
