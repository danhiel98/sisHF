		...
		<table class="table table-bordered table-hover table-responsive">
			...
			<tr>
				...
				<td style="width: 50px; max-width: 60px;">
					<form class="frmDtos" data-id="<?php echo $mp->id; ?>" action="ajax/buy/addtore.php" method="post">
				...
				<td style="width:50px;">
					<?php if (!$found): ?>
						<button disabled type="submit" class="btn btn-success btn-sm btnEnviar" data-id="<?php echo $mp->id; ?>"><i class="fa fa-cart-plus"></i> </button>
					<?php else: ?>
						<!--<button type="submit" class="btn btn-info btn-sm btnEnviar" data-id="<?php echo $mp->id; ?>"><i class="fa fa-refresh"></i></button>-->
